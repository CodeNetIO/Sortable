...
namespace Sortable
{
    ...
    public class Player : IComparable<Player>
    {
        ...
        /// <summary>
        /// Compares the current player's experience with another player's.
        /// </summary>
        /// <returns>
        /// 0 if experience is equal, +1 if greater than the other, or -1 if less.
        /// </returns>
        /// <param name="other">A player to compare experience with.</param>
        /// <exception cref="ArgumentException">
        /// Object is not a <see cref="Player"/>.
        /// </exception>
        public int CompareTo(object other)
        {
            ...
            if (player == null)
            {
                throw new ArgumentException(
                    "Object to be compared is not a player.", nameof(player));
            }
